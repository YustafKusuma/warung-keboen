...
import { View, Text, StyleSheet, StatusBar, Image, TouchableOpacity, TextInput, FlatList
} from 'react-native';
  ...
  closeDropdown(pageX, pageY)
    ...
    <StatusBar
      ...
      <View style={styles.headerContainer}>
        ...
        />
        <Text style={styles.headerTitle}>Login into Warung Keboen</Text>
      </View>
      <Text style={styles.title}>Register Phone Number</Text>
      <Text style={styles.content}>Masukkan nomor telepon terdaftar untuk melanjutkan masuk</Text>
