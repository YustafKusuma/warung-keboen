  ...
  return (
    <SafeAreaView style= {{flex: 1, backgroundColor: 'white'}}>
        <View style= {style.header}>
          <Ionicons name= 'arrow-back' color= '#8BD272' size={36} onPress={() => navigation.goBack()} />
        </View>
        ...
        <View style={style.detailsContainer}>
          <View style= {{marginLeft: 20, flexDirection: 'row', alignItems: 'flex-end',}}>
            ...
            <View style= {{marginLeft: 20, marginTop: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',}}>
              <Text style= {{fontSize: 26, fontWeight: 'bold'}}>{plant.name}</Text>
            <View style= {style.priceTag}>
              <Text style= {{ marginLeft: 24, color: 'white', fontWeight: 'bold', fontSize: 18,}}>
                Rp.{plant.price}
              </Text>
            </View>
          </View>
