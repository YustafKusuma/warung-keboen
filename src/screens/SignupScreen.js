    ...
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <Ionicons
          ...
          size={30} color = {Colors.DEFAULT_BLACK}
      ...
      <View style={inputStyle(usernameState)}>
            <View style = {styles.inputSubContainer}>
                <Feather name="user" size={23} color={Colors.DEFAULT_GREEN} style={{marginRight: 10}}/>
                <TextInput
        ...
        <View style={inputStyle(emailState)}>
            <View style = {styles.inputSubContainer}>
                <Feather name="mail" size={23} color={Colors.DEFAULT_GREEN} style={{marginRight: 10}}/>
                <TextInput
                    placeholder='Email'  
                    placeholderTextColor={Colors.DEFAULT_GREY}
                    selectionColor={Colors.DEFAULT_GREY}
        ...
        <View style = {styles.inputContainer}>
            <View style = {styles.inputSubContainer}>
                <Feather name="lock" size={22} color={Colors.DEFAULT_GREEN} style={{marginRight: 10}}/>
                    <TextInput
                    ...
                    <Feather name={isPasswordShow ? 'eye' : 'eye-off'} size={23} color={Colors.DEFAULT_GREY} style={{marginRight: 10}}
